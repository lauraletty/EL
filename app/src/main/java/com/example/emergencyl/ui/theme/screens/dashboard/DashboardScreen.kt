package com.example.emergencyl.ui.theme.screens.dashboard
        ...
        Column(modifier = Modifier
            ...
            Row (modifier = Modifier
                ...
                Column {
                    ...
                    Spacer(modifier = Modifier
                        .height(5.dp)
                        .clickable { navController.navigate(FAINT_URL) })
                    Text(
                        text = "Faint",
                        fontSize = 15.sp,
                        fontFamily = FontFamily.Serif,
            ...
            Row (modifier = Modifier
                ...
                Column {
                    ...
                    Spacer(modifier = Modifier
                        .height(5.dp)
                        .clickable { navController.navigate(NOSEBLEED_URL) })
                    Text(
                        text = "Chestpain",
                        fontSize = 15.sp,
                        fontFamily = FontFamily.Serif,
                ...
                Column {
                    ...
                    Spacer(modifier = Modifier
                        .height(5.dp)
                        .clickable { navController.navigate(HEARTATTACK_URL) })
                    Text(
                        text = "Heartattack",
                        fontSize = 15.sp,
                        fontFamily = FontFamily.Serif,
